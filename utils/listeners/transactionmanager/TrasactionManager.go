...
import(
    ...
    automatlocation "internal/automatlocation"
...
func handler(w http.ResponseWriter, req *http.Request) {
    ...
    case "POST":
        ...
        if resultFoundActiveTid == true {
            ...
            noise,Id := AddTransaction(requestCheck)
...
var FiscalManager fiscalmanager.FiscalManager
...
var AutomatLocationStore automatlocation.StoreAutomatLocation
