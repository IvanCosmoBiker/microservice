...
import (
	...
	model "ephorservices/pkg/model/schema/account/config/model"
...
func NewStore(conn *connectionPostgresql.Manager) *StoreConfig {
...
func (sc *StoreConfig) Get(accountId interface{}) ([]*model.ReturningStruct, error) {
...
func (sc *StoreConfig) AddByParams(parametrs map[string]interface{}) (*model.ReturningStruct, error) {
...
func (sc *StoreConfig) SetByParams(parametrs map[string]interface{}) (*model.ReturningStruct, error) {
...
func (sc *StoreConfig) GetOneById(id, accountId interface{}) (*model.ReturningStruct, error) {
...
func (sc *StoreConfig) GetDataOfStruct(ctx context.Context, sql string, args ...interface{}) (*model.ReturningStruct, error) {
	var result *model.ReturningStruct
...
func (sc *StoreConfig) GetDataOfMapStuct(ctx context.Context, sql string, args ...interface{}) ([]*model.ReturningStruct, error) {
	var result []*model.ReturningStruct
...
func (sc *StoreConfig) GetWithOptions(options map[string]interface{}) ([]*model.ReturningStruct, error) {
	var result []*model.ReturningStruct
...
func (sac *StoreConfig) GetOneWithOptions(options map[string]interface{}) (*model.ReturningStruct, error) {
	var result *model.ReturningStruct
