...
func NewStore(conn *connectionPostgresql.Manager) *StoreModem {
...
func (sc *StoreModem) Get() ([]*model.ReturningStruct, error) {
...
func (sc *StoreModem) AddByParams(parametrs map[string]interface{}) (*model.ReturningStruct, error) {
	ctx := context.Background()
...
func (sc *StoreModem) SetByParams(parametrs map[string]interface{}) (*model.ReturningStruct, error) {
...
func (sc *StoreModem) GetOneById(id interface{}) (*model.ReturningStruct, error) {
...
func (sc *StoreModem) GetDataOfStruct(ctx context.Context, sql string, args ...interface{}) (*model.ReturningStruct, error) {
	var result *model.ReturningStruct
...
func (sc *StoreModem) GetDataOfMapStuct(ctx context.Context, sql string, args ...interface{}) ([]*model.ReturningStruct, error) {
	var result []*model.ReturningStruct
...
func (sc *StoreModem) GetWithOptions(options map[string]interface{}) ([]*model.ReturningStruct, error) {
	ctx := context.Background()
	sqlField, sqlWhere, valuesWhere := sc.Connection.Conn.PrepareGet(options, sc.model)
	sql := fmt.Sprintf("SELECT %v FROM %v.%v %v", sqlField, sc.model.GetNameSchema(""), sc.model.GetNameTable(), sqlWhere)
	log.Println(sql)
